...
import {solveRequiredPower} from './utils/cyclingClimbCalc'
...
// Save to localStorage on change
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-background to-muted/10 flex justify-center items-start py-8">
            <div
                className="w-full max-w-[420px] px-3 py-6 bg-background rounded-lg shadow-md md:shadow-lg md:border md:border-border/30 mx-auto">
                ...
                <Card className="shadow-sm border-0 overflow-hidden mb-4">
                    ...
                    <CardContent className="pt-3">
                        <div className="space-y-1">
                            ...
                            />
                            {gpxFile &&
                                <p className="text-xs text-primary mt-1 font-medium">Selected: {gpxFile.name}</p>}
                        </div>
                    </CardContent>
                </Card>
                        ...
                        <CardContent className="pt-3">
                            <div className="grid grid-cols-2 gap-2">
                                {Object.entries(gradientResults).map(([distance, gradient]) => (
                                    <div key={distance}
                                         className="flex flex-col items-center justify-center p-2 bg-muted/20 border border-muted/30">
                    ...
                    <Card className="shadow-sm border-0 overflow-hidden mb-4">
                        ...
                        <CardContent className="pt-3 space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="cassette-teeth" className="text-xs font-medium">Cassette
                                        Teeth</Label>
                                    <Input
                                        type="number"
                                        id="cassette-teeth"
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1">
                                    <Label htmlFor="wheel-circumference" className="text-xs font-medium">Wheel
                                        Size</Label>
                                    <Select value={wheelCircumference}
                                            onValueChange={(value) => setWheelCircumference(value as WheelCircumference)}>
